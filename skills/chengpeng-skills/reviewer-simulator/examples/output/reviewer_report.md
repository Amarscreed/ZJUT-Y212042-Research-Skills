...
## Reviewer 1 (Style: constructive)
**Decision:** Weak Accept
**Overall Score:** 3.8/5.0

### Scores
- Novelty (1-5): 3/5 [###--]
- Technical Soundness (1-5): 4/5 [####-]
- Experimental Rigor (1-5): 4/5 [####-]
- Clarity (1-5): 4/5 [####-]
- Reproducibility (1-5): 4/5 [####-]

### Summary
I appreciate the effort.  I believe with revisions this work could be strengthened significantly.

### Strengths
- Good technical soundness.
- Good experimental rigor.
- Good clarity.
- Good reproducibility.

### Weaknesses
- No code/data availability link provided — crucial for reproducibility.
- No statistical significance testing reported.
- Only one dataset tested — generalization is questionable.

### Questions for Authors
- How does the proposed method generalize across different patient populations?
- Can the authors provide more ablation studies on disease-aware semantic tokens (DASTs) and dual-modal retrieval?
- What are the failure cases of the proposed approach?

## Reviewer 2 (Style: critical)
**Decision:** Weak Accept
**Overall Score:** 3.6/5.0

### Scores
- Novelty (1-5): 4/5 [####-]
- Technical Soundness (1-5): 3/5 [###--]
- Experimental Rigor (1-5): 3/5 [###--]
- Clarity (1-5): 4/5 [####-]
- Reproducibility (1-5): 4/5 [####-]

### Summary
 The paper has fundamental issues that need to be addressed before acceptance.
...
### Summary
The paper addresses an interesting problem.  With appropriate revisions, it could be a solid contribution.
...
- Novelty (1-5): 3.7/5.0
- Technical Soundness (1-5): 3.7/5.0
- Experimental Rigor (1-5): 3.7/5.0
- Clarity (1-5): 4.0/5.0
- Reproducibility (1-5): 4.0/5.0

**Average Overall:** 3.8/5.0
